...
const Config = function () {
  ...
  this.channel = this.androidChannel = 'development'
...
Config.prototype.buildArgs = function () {
  ...
  if (this.targetOS === 'android') {
    ...
    args.android_channel = this.androidChannel
...
Config.prototype.update = function (options) {
  ...
  if (options.target_os === 'android') {
    ...
    if (options.android_channel) {
      this.androidChannel = options.android_channel
    }
  }
  ...
  if (this.targetOS === 'android') {
    this.androidChannel = this.channel
    if (this.androidChannel === '') {
      this.androidChannel = 'stable'
    }
  }
